...
public class PostSurvey4_Activity extends AppCompatActivity {
    private String username;
    private DatabaseReference db;
    private Button button_back;
    private Button button_next;

    private String scale_answer16;
    private String scale_answer17;
    private String scale_answer18;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityRef = db.child("userActivity").child(username).child("PostSurvey_4");
        ...
        radiogroup1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                scale_answer16 = selected_button_1.getText().toString();
            }
        });
        ...
        radiogroup2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton selected_button_1 = (RadioButton) findViewById(checkedId);
                scale_answer17 = selected_button_1.getText().toString();
            }
        });
        ...
        radiogroup3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton selected_button_1 = (RadioButton) findViewById(checkedId);
                scale_answer18 = selected_button_1.getText().toString();
            }
        });
        ...
        radiogroup4.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton selected_button_1 = (RadioButton) findViewById(checkedId);
                scale_answer19 = selected_button_1.getText().toString();
            }
        });
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (scale_answer16==null || scale_answer17==null || scale_answer18==null || scale_answer19==null || scale_answer20==null){
                    Toast.makeText(PostSurvey4_Activity.this,  "Empty input", Toast.LENGTH_SHORT).show();
                } else {
                    db.child("PostSurvey").child(username).child("16").setValue(scale_answer16);
                    db.child("PostSurvey").child(username).child("17").setValue(scale_answer17);
                    db.child("PostSurvey").child(username).child("18").setValue(scale_answer18);
                    db.child("PostSurvey").child(username).child("19").setValue(scale_answer19);
                    db.child("PostSurvey").child(username).child("20").setValue(scale_answer20);
