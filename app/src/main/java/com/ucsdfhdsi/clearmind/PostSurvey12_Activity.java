...
public class PostSurvey12_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityRef = db.child("userActivity").child(username).child("PostSurvey_12");
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (scale_answer57==null || scale_answer58==null || scale_answer59==null || scale_answer60==null || scale_answer61==null){
                    Toast.makeText(PostSurvey12_Activity.this,  "Empty input", Toast.LENGTH_SHORT).show();
                } else {
                    db.child("PostSurvey").child(username).child("57").setValue(scale_answer57);
                    db.child("PostSurvey").child(username).child("58").setValue(scale_answer58);
                    db.child("PostSurvey").child(username).child("59").setValue(scale_answer59);
                    db.child("PostSurvey").child(username).child("60").setValue(scale_answer60);
                    db.child("PostSurvey").child(username).child("61").setValue(scale_answer61);
    ...
    private void open_Previous_Activity() {
        Intent intent = new Intent(this,PostSurvey11_Activity.class);
    ...
    private void open_Next_Activity() {
        Intent intent = new Intent(this,PostSurvey13_Activity.class);
        intent.putExtra("username", username);
        intent.putExtra("activityId", activityId);
        ...
        db.child("PostSurvey").child(username).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                ...
                if(!task.isSuccessful()){
                    ...
                    if(hashmap_presurvey.size() > 57){

                        String current_answer57 = hashmap_presurvey.get(57);
                        switch (current_answer57) {
                            case "1":
                        ...
                        String current_answer58 = hashmap_presurvey.get(58);
                        switch (current_answer58) {
                            case "1":
                        ...
                        String current_answer59 = hashmap_presurvey.get(59);
                        switch (current_answer59) {
                            case "1":
                        ...
                        String current_answer60 = hashmap_presurvey.get(60);
                        switch (current_answer60) {
                            case "1":
                        ...
                        String current_answer61 = hashmap_presurvey.get(61);
                        switch (current_answer61) {
                            case "1":
