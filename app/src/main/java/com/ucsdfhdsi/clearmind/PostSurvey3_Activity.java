...
public class PostSurvey3_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityRef = db.child("userActivity").child(username).child("PostSurvey_3");
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (scale_answer11==null || scale_answer12==null || scale_answer13==null || scale_answer14==null || scale_answer15==null){
                    Toast.makeText(PostSurvey3_Activity.this,  "Empty input", Toast.LENGTH_SHORT).show();
                } else {
                    db.child("PostSurvey").child(username).child("11").setValue(scale_answer11);
                    db.child("PostSurvey").child(username).child("12").setValue(scale_answer12);
                    db.child("PostSurvey").child(username).child("13").setValue(scale_answer13);
                    db.child("PostSurvey").child(username).child("14").setValue(scale_answer14);
                    db.child("PostSurvey").child(username).child("15").setValue(scale_answer15);
        ...
        db.child("PostSurvey").child(username).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                ...
                if(!task.isSuccessful()){
                    ...
                    if(hashmap_presurvey.size() > 11){

                        String current_answer11 = hashmap_presurvey.get(11);
                        switch (current_answer11) {
                            case "1":
                        ...
                        String current_answer12 = hashmap_presurvey.get(12);
                        switch (current_answer12) {
                            case "1":
                        ...
                        String current_answer13 = hashmap_presurvey.get(13);
                        switch (current_answer13) {
                            case "1":
                        ...
                        String current_answer14 = hashmap_presurvey.get(14);
                        switch (current_answer14) {
                            case "1":
                        ...
                        String current_answer15 = hashmap_presurvey.get(15);
                        switch (current_answer15) {
                            case "1":
