...
public class Chapter3_Summary_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chapter3_summary);
        ...
        db.child("Chapter3").child("summary").child(username).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            @Override
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (txt_answer1.isEmpty() || txt_answer2.isEmpty() || txt_answer3 == null){
                    Toast.makeText(Chapter3_Summary_Activity.this,  "Empty input", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    db.child("Chapter3").child("summary").child(username).setValue(map);
                    ...
                    chapter_progress_update.put("9_Summary", "1");
...
//        sendTimeStampsToFirebase();
    ...
    private void sendTimeStampsToFirebase() {
        DatabaseReference activityRef = db.child("userActivity").child(username).child("Part3_7_Summary");
