...
public class PostSurvey1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityRef = db.child("userActivity").child(username).child("PostSurvey_1");
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (scale_answer1==null || scale_answer2==null || scale_answer3==null || scale_answer4==null || scale_answer5==null){
                    Toast.makeText(PostSurvey1_Activity.this,  "Empty input", Toast.LENGTH_SHORT).show();
                } else {
                    db.child("PostSurvey").child(username).child("1").setValue(scale_answer1);
                    db.child("PostSurvey").child(username).child("2").setValue(scale_answer2);
                    db.child("PostSurvey").child(username).child("3").setValue(scale_answer3);
                    db.child("PostSurvey").child(username).child("4").setValue(scale_answer4);
                    db.child("PostSurvey").child(username).child("5").setValue(scale_answer5);
...
//        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
    ...
    private void open_Next_Activity() {
        Intent intent = new Intent(this,PostSurvey2_Activity.class);
        intent.putExtra("username", username);
        intent.putExtra("activityId", activityId);
        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
        startActivity(intent);
...
//        }
    ...
    private void sendTimeStampsToFirebase() {
        ...
        if (activityId != null) {
            ...
            db.child("userActivity").child(username).child("PostSurvey_0_All").child(activityId).child("openTime_ms").setValue(pageOpenTime);
            db.child("userActivity").child(username).child("PostSurvey_0_All").child(activityId).child("openTime_str").setValue(String.valueOf(resultdate_open));

            db.child("userActivity").child(username).child("PostSurvey_0_Scale_1").child(activityId).child("openTime_ms").setValue(pageOpenTime);
            db.child("userActivity").child(username).child("PostSurvey_0_Scale_1").child(activityId).child("openTime_str").setValue(String.valueOf(resultdate_open));
        }
    }
