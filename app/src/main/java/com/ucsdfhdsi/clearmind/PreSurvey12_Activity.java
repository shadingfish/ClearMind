...
public class PreSurvey12_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityRef = db.child("userActivity").child(username).child("PreSurvey_12");
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (scale_answer52==null || scale_answer53==null || scale_answer54==null || scale_answer55==null || scale_answer56==null){
                    Toast.makeText(PreSurvey12_Activity.this,  "Empty input", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    db.child("PreSurvey").child(username).child("56").setValue(scale_answer56);
        ...
        db.child("PreSurvey").child(username).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                ...
                if(!task.isSuccessful()){
                    ...
                    if(hashmap_presurvey.get("52") != null){
