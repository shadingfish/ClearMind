...
public class PostSurvey10_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityRef = db.child("userActivity").child(username).child("PostSurvey_10");
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (scale_answer47==null || scale_answer48==null || scale_answer49==null || scale_answer50==null || scale_answer51==null){
                    Toast.makeText(PostSurvey10_Activity.this,  "Empty input", Toast.LENGTH_SHORT).show();
                } else {
                    db.child("PostSurvey").child(username).child("47").setValue(scale_answer47);
                    db.child("PostSurvey").child(username).child("48").setValue(scale_answer48);
                    db.child("PostSurvey").child(username).child("49").setValue(scale_answer49);
                    db.child("PostSurvey").child(username).child("50").setValue(scale_answer50);
                    db.child("PostSurvey").child(username).child("51").setValue(scale_answer51);
