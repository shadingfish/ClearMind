...
public class PostSurvey6_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityRef = db.child("userActivity").child(username).child("PostSurvey_6");
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (scale_answer26==null || scale_answer27==null || scale_answer28==null || scale_answer29==null || scale_answer30==null || scale_answer31==null){
                    Toast.makeText(PostSurvey6_Activity.this,  "Empty input", Toast.LENGTH_SHORT).show();
                } else {
                    db.child("PostSurvey").child(username).child("26").setValue(scale_answer26);
                    db.child("PostSurvey").child(username).child("27").setValue(scale_answer27);
                    db.child("PostSurvey").child(username).child("28").setValue(scale_answer28);
                    db.child("PostSurvey").child(username).child("29").setValue(scale_answer29);
                    db.child("PostSurvey").child(username).child("30").setValue(scale_answer30);
                    db.child("PostSurvey").child(username).child("31").setValue(scale_answer31);
    ...
    private void open_Previous_Activity() {
        Intent intent = new Intent(this,PostSurvey5_Activity.class);
...
//        }
    ...
    private void sendTimeStampsToFirebase() {
        ...
        if (activityId != null) {
            ...
            db.child("userActivity").child(username).child("PostSurvey_0_Scale_2").child(activityId).child("openTime_ms").setValue(pageOpenTime);
            db.child("userActivity").child(username).child("PostSurvey_0_Scale_2").child(activityId).child("openTime_str").setValue(String.valueOf(resultdate_open));
        }
    }
        ...
        db.child("PostSurvey").child(username).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                ...
                if(!task.isSuccessful()){
                    ...
                    if(hashmap_presurvey.size() > 26){

                        String current_answer26 = hashmap_presurvey.get(26);
                        switch (current_answer26) {
                            case "1":
                        ...
                        String current_answer27 = hashmap_presurvey.get(27);
                        switch (current_answer27) {
                            case "1":
                        ...
                        String current_answer28 = hashmap_presurvey.get(28);
                        switch (current_answer28) {
                            case "1":
                        ...
                        String current_answer29 = hashmap_presurvey.get(29);
                        switch (current_answer29) {
                            case "1":
                        ...
                        String current_answer30 = hashmap_presurvey.get(30);
                        switch (current_answer30) {
                            case "1":
                        ...
                        String current_answer31 = hashmap_presurvey.get(31);
                        switch (current_answer31) {
                            case "1":
                                radiogroup6.check(R.id.radiobtn_21);
                                break;
                            case "2":
                                radiogroup6.check(R.id.radiobtn_22);
                                break;
                            case "3":
                                radiogroup6.check(R.id.radiobtn_23);
                                break;
                            case "4":
                                radiogroup6.check(R.id.radiobtn_24);
                                break;
                        };
                    }
                }
