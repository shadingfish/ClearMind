...
public class PostSurvey7_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_survey_8);
        ...
        activityRef = db.child("userActivity").child(username).child("PostSurvey_7");
        ...
        radiogroup5.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton selected_button_1 = (RadioButton) findViewById(checkedId);
                scale_answer36 = selected_button_1.getText().toString();
            }
        });
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (scale_answer32==null || scale_answer33==null || scale_answer34==null || scale_answer35==null || scale_answer36==null){
                    Toast.makeText(PostSurvey7_Activity.this,  "Empty input", Toast.LENGTH_SHORT).show();
                } else {
                    db.child("PostSurvey").child(username).child("32").setValue(scale_answer32);
                    db.child("PostSurvey").child(username).child("33").setValue(scale_answer33);
                    db.child("PostSurvey").child(username).child("34").setValue(scale_answer34);
                    db.child("PostSurvey").child(username).child("35").setValue(scale_answer35);
                    db.child("PostSurvey").child(username).child("36").setValue(scale_answer36);
    ...
    private void open_Previous_Activity() {
        Intent intent = new Intent(this,PostSurvey6_Activity.class);
...
//        }
    ...
    private void sendTimeStampsToFirebase() {
        ...
        if (activityId != null) {
            ...
            db.child("userActivity").child(username).child("PostSurvey_0_Scale_2").child(activityId).child("openTime_ms").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                @Override
                public void onComplete(@NonNull Task<DataSnapshot> task) {
                    long OpenTime_Scale2 = (long) task.getResult().getValue();
                    if(!task.isSuccessful()){
                        ...
                        if(OpenTime_Scale2 != 0){
                            db.child("userActivity").child(username).child("PostSurvey_0_Scale_2").child(activityId).child("duration").setValue(pageCloseTime - OpenTime_Scale2);
                        }
                    }
                }
            });
            ...
            db.child("userActivity").child(username).child("PostSurvey_0_Scale_2").child(activityId).child("closeTime_ms").setValue(pageCloseTime);
            db.child("userActivity").child(username).child("PostSurvey_0_Scale_2").child(activityId).child("closeTime_str").setValue(String.valueOf(resultdate_close));
        }
    }
        ...
        db.child("PostSurvey").child(username).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                ...
                if(!task.isSuccessful()){
                    ...
                    Log.d("firebase_postsurvey", String.valueOf(task.getResult().getValue()));
                    if(hashmap_presurvey.size() > 32){

                        String current_answer32 = hashmap_presurvey.get(32);
                        switch (current_answer32) {
                            case "1":
                        ...
                        String current_answer33 = hashmap_presurvey.get(33);
                        switch (current_answer33) {
                            case "1":
                        ...
                        String current_answer34 = hashmap_presurvey.get(34);
                        switch (current_answer34) {
                            case "1":
                        ...
                        String current_answer35 = hashmap_presurvey.get(35);
                        switch (current_answer35) {
                            case "1":
                        ...
                        String current_answer36 = hashmap_presurvey.get(36);
                        switch (current_answer36) {
                            case "1":
