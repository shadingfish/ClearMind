        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (scale_answer16==null || scale_answer17==null || scale_answer18==null || scale_answer19==null || scale_answer20==null){
                    ...
                    db.child("PreSurvey").child(username).child("16").setValue(scale_answer16);
                    db.child("PreSurvey").child(username).child("17").setValue(scale_answer17);
                    db.child("PreSurvey").child(username).child("18").setValue(scale_answer18);
                    db.child("PreSurvey").child(username).child("19").setValue(scale_answer19);
