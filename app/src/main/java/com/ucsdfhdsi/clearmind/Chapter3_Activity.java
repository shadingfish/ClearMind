...
public class Chapter3_Activity extends AppCompatActivity {
    ...
    private Button button_activity5_1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.activity_chapter3), (v, windowInsets) -> {
...
//            mlp.rightMargin = insets.right;
        ...
        button_activity3 = findViewById(R.id.button4);
        button_activity4 = findViewById(R.id.button5);
        button_activity5_1 = findViewById(R.id.button6);
...
//        progress_map.put("2_Activity3_1", "0");
//        progress_map.put("3_Activity3_2", "0");
//        progress_map.put("4_Activity3_3", "0");
//        progress_map.put("5_Activity3_4", "0");
//        progress_map.put("6_Activity3_5_1", "0");
//        progress_map.put("7_Activity3_5_2", "0");
//        progress_map.put("8_Activity3_6", "0");
//        progress_map.put("9_Summary", "0");
//        this.db.child("Chapter3").child("progress").child(username).setValue(progress_map);
    ...
    private void open_Chapter3_Activity4() {
        Intent intent = new Intent(this,Chapter3_Activity4_Activity.class);
        intent.putExtra("username", username);
        startActivity(intent);
    }

    private void open_Chapter3_Activity5_1() {
    ...
    public void getData() {
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String status_1 = String.valueOf(snapshot.child("Chapter3").child("progress").child(username).child("1_Opening").getValue());
                String status_2 = String.valueOf(snapshot.child("Chapter3").child("progress").child(username).child("2_Activity3_1").getValue());
                String status_3 = String.valueOf(snapshot.child("Chapter3").child("progress").child(username).child("3_Activity3_2").getValue());
                    ...
                    button_activity1.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if(status_1.equals("1")){
                                Toast.makeText(Chapter3_Activity.this, "Open Activity1", Toast.LENGTH_SHORT).show();
                                open_Chapter3_Activity1();
                            } else{
...
//                            Log.d("Chapter2 Check", status_2);
                ...
                if (status_4.equals("0")){
                    ...
                    // status == "1"
                    Drawable icon_done = getResources().getDrawable(R.drawable.icon_meditation_done);
                    icon_done.setBounds(0,0,icon_done.getMinimumWidth(), icon_done.getMinimumHeight());
                ...
                if (status_6.equals("0")){
                    button_activity5_1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            if(status_5.equals("1")){
                                Toast.makeText(Chapter3_Activity.this, "Open", Toast.LENGTH_SHORT).show();
                                open_Chapter3_Activity5_1();
                            } else{
                                Toast.makeText(Chapter3_Activity.this, "Please complete previous content first!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    ...
                    icon_done.setBounds(0,0,icon_done.getMinimumWidth(), icon_done.getMinimumHeight());
                    button_activity5_1.setCompoundDrawables(icon_done, null, null, null);
                    button_activity5_1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            open_Chapter3_Activity5_1();
...
//                    finish_word.setText("You have finished this Chapter!");
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Chapter3_Activity.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
